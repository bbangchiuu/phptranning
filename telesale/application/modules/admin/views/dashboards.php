...
<?php $this->load->view('template/asides') ?>
    ...
    <div id="content" class="app-content" role="main">
      <div class="app-content-body ">
        ...
        <div class="hbox hbox-auto-xs hbox-auto-sm" ng-init="app.settings.asideFolded = true; app.settings.asideDock = true;">
          <!-- main -->
          <div class="col">
                  ...
                  <div class="list-group list-group-lg list-group-sp">
                    ...
                    <a herf class="list-group-item clearfix">
                      ...
                      <span class="clear">
                        ...
                        <small class="text-muted clear text-ellipsis">Come online and we need talk about the plans that
                          we have discussed</small>
                      </span>
                    </a>
                    <a herf class="list-group-item clearfix">
                      <span class="pull-left thumb-sm avatar m-r">
