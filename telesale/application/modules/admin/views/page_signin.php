...
<div class="container w-xxl w-auto-xs" ng-controller="SigninFormController" ng-init="app.settings.container = false;">
  ...
  <div class="m-b-lg">
    ...
    ?>
    <form name="form" class="form-validation" method="post" action="http://localhost/telesales/page_signin.html">
        ...
        <a href="http://localhost/telesales/page_signup.html" ui-sref="access.signup" class="btn btn-lg btn-default btn-block">Create an account</a>
    </form>
  </div>
