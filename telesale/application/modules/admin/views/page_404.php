...
<div class="container w-xxl w-auto-xs" ng-init="app.settings.container = false;">
  ...
  <div class="list-group bg-info auto m-b-sm m-b-lg">
    ...
    <a href="http://localhost:8080/telesale/page_signin.html" ui-sref="access.signin" class="list-group-item">
      <i class="fa fa-chevron-right text-muted"></i>
      <i class="fa fa-fw fa-sign-in m-r-xs"></i> Sign in
    </a>
    <a href="http://localhost:8080/telesale/page_signup.html" ui-sref="access.signup" class="list-group-item">
      <i class="fa fa-chevron-right text-muted"></i>
