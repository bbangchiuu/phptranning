...
(function($){
	$.fn.zPaging = function(options){
		...
		function init(){
			...
			console.log("hello");
			$.ajax({
				url		: "http://localhost:8080/www/demoAjax/04-paging/files/getdata.php?type=count&items=" + options.items,
				type	: "GET",
				dataType: "json"
			}).done(function(data){
		...
		function loadData(page){
			console.log(page);
			$.ajax({
				url: "http://localhost:8080/www/demoAjax/04-paging/files/getdata.php?type=list",
				type: "POST",
				dataType: "json",
				cache: false,
				data: {
		...
		function deleteItem(obj){
			...
			$(parent).fadeOut({
				durarion: 300,
						...
						$.ajax({
							url: "http://localhost:8080/www/demoAjax/04-paging/files/getdata.php?type=delete&id=" + itemID,
							type: "GET",
							dataType:"json"
						});
			...
			$.ajax({
				url: "http://localhost:8080/www/demoAjax/04-paging/files/getdata.php?type=one&id=" + lastID,
				type: "GET",
				dataType:"json"
			}).done(function(data){
				console.log(data);
